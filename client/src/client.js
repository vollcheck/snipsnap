...
export const deleteSnap = async (snapId) => {
  ...
  return await client.delete("/snap/" + snapId).then((response) => response.data);
}
...
export const getUser = async (username) => {
  return await client.get("/user/" + username).then((response) => response.data);
}

export const editUser = async (username, data) => {
  // for update you need to be authorized
  return await client.post("/user/" + username, data).then((response) => response.data);
}

export const deleteUser = async (username) => {
  // for update you need to be authorized
  return await client.delete("/user/" + username).then((response) => response.data);
}
